 ...
 * 
 * kbled - daemon to control LED backlight
 */
...
#define BKLTDEFAULT {0,0,0}  //backlight default color: off unless specified in command line
#define FOCUSDEFAULT {0,63,0}  //focus default color: 1/4 brightness green unless specified in command line
...
int main(int argc, char **argv){
    ...
    uint8_t newstate=0;
    uint8_t backlight[3]=BKLTDEFAULT; //default if not specified by command line arguments
    uint8_t focus[3]=FOCUSDEFAULT;  //default if not specified by command line arguments
